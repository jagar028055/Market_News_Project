...
class PodcastPublisher:
    ...
    def retry_failed_publish(self, episode: Dict, failed_channels: List[str], max_retries: int = 3) -> Dict[str, bool]:
        """失敗した配信の再試行
    ...
    def validate_episode_data(self, episode: Dict) -> bool:
        """エピソードデータの妥当性検証"""
        required_fields = [
            'title', 'description', 'audio_filename', 
            'duration', 'file_size', 'pub_date', 'guid'
        ]
