...
class FlexMessageTemplates:
    ...
    def create_podcast_notification_flex(
        self,
            ...
            flex_message = {
                ...
                "contents": {
                    ...
                    "body": self._create_body(
                        highlights, duration_min, file_size_mb, article_count
                    ),
    ...
    def _create_body(
        self, highlights: List[str], duration_min: int, file_size_mb: float, article_count: int
    ) -> Dict[str, Any]:
        """
        ボディ部分を作成
        ...
        return {"type": "box", "layout": "vertical", "contents": contents, "paddingAll": "15px"}
    ...
    def _create_footer(self, audio_url: Optional[str], rss_url: Optional[str]) -> Dict[str, Any]:
        ...
        if rss_url:
            buttons.append(
                {
                    "type": "button",
                    "action": {"type": "uri", "label": f"{self.icons['rss']} RSS", "uri": rss_url},
                    "style": "secondary",
                    "flex": 1,
                }
            )
    ...
    def _create_styles(self) -> Dict[str, Any]:
        ...
        """
        return {
            "header": {"backgroundColor": self.colors["primary"]},
    ...
    def _create_simple_fallback_message(
        self, episode_info: Dict[str, Any], articles: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
