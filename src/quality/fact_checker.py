...
class FactChecker:
    ...
    def check_article_facts(self, article: Dict[str, Any]) -> FactCheckResult:
        ...
        self.logger.info(f"ファクトチェック完了: スコア={result.accuracy_score:.1f}, 信頼度={confidence_level}")
        return result
    ...
    def _verify_numerical_claim(self, claim: Dict[str, Any], market_snapshot: MarketSnapshot, article: Dict[str, Any]) -> Dict[str, Any]:
        """数値的主張を検証"""
    ...
    def _verify_percentage_claim(self, percentage: float, context: str, market_snapshot: MarketSnapshot) -> Dict[str, Any]:
        """パーセンテージ主張を検証"""
    ...
    def _verify_usdjpy_rate(self, claimed_rate: float, market_snapshot: MarketSnapshot) -> Dict[str, Any]:
        """USD/JPY為替レートを検証"""
    ...
    def _verify_price_claim(self, price: float, context: str, market_snapshot: MarketSnapshot) -> Dict[str, Any]:
        """価格主張を検証"""
    ...
    def _check_date_consistency(self, article: Dict[str, Any], market_snapshot: MarketSnapshot) -> Dict[str, Any]:
        """日付整合性をチェック"""
        issues = []
        ...
        if published_jst:
            try:
                ...
                if time_diff > 24:
                    issues.append(f"記事公開時刻({pub_date})と市場データ時刻({market_time})の差が大きすぎます")
    ...
    def _check_trend_consistency(self, article: Dict[str, Any], market_snapshot: MarketSnapshot) -> Dict[str, Any]:
        """市場トレンド整合性をチェック"""
