...
class TestAppConfig(unittest.TestCase):
    ...
    def test_to_legacy_format(self):
        ...
        self.assertEqual(
            legacy_format["SENTIMENT_ANALYSIS_ENABLED"], config.scraping.sentiment_analysis_enabled
        )
        self.assertEqual(
            legacy_format["AI_PROCESS_PROMPT_TEMPLATE"], config.ai.process_prompt_template
        )
        ...
        self.assertEqual(
            legacy_format["BLOOMBERG_CONFIG"]["exclude_keywords"], config.bloomberg.exclude_keywords
        )
