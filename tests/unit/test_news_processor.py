...
class TestNewsProcessor(unittest.TestCase):
    ...
    @patch.dict(
        os.environ,
        {"GOOGLE_DRIVE_OUTPUT_FOLDER_ID": "test_folder", "AI_GEMINI_API_KEY": "test_key"},
    )
    ...
    def test_generate_html_output_success(self, mock_html_generator):
        ...
        mock_generator_instance.generate_html_file.assert_called_once_with(
            self.sample_articles, "index.html"
        )
